...
create or replace transient table DB_T4.FAN_intermediate.int_ticket_sales_dedup
    
    
    
    as (-- Intermediate layer: Deduplicate ticket sales by natural key
...
WITH ranked AS (
    ...
    FROM DB_T4.FAN_staging.stg_ticket_sales ts
)
