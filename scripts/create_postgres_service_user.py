...
def create_service_user():
    ...
    try:
        ...
        cursor.execute("GRANT ALL PRIVILEGES ON ALL TABLES IN SCHEMA staging TO service;")
        cursor.execute("GRANT ALL PRIVILEGES ON ALL SEQUENCES IN SCHEMA staging TO service;")
        
        # Grant privileges on future tables
        cursor.execute("ALTER DEFAULT PRIVILEGES IN SCHEMA staging GRANT ALL ON TABLES TO service;")
        cursor.execute("ALTER DEFAULT PRIVILEGES IN SCHEMA staging GRANT ALL ON SEQUENCES TO service;")
