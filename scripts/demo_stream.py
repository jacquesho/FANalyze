...
def run_demo():
    ...
    print("   Command: python scripts/stream_tickets.py --speed 10 --duration 2 --format console")
    
    print("\n2. JSON Lines output (5x speed, 1 minute):")
    print("   Command: python scripts/stream_tickets.py --speed 5 --duration 1 --format jsonl")
    
    print("\n3. Limited events (20x speed, max 50 events):")
    print("   Command: python scripts/stream_tickets.py --speed 20 --max-events 50 --format console")
