...
def run_streaming_demo():
    ...
    while True:
        ...
        if choice == '1':
            ...
            print_step(3, "Real-time Simulation", "1x speed, 30 seconds - Shows realistic timing")
            ...
            print_step(4, "Limited Events Demo", "50x speed, 50 events - Shows controlled output")
            ...
            speed = input("Enter speed multiplier (1-100, default 10): ").strip() or "10"
            duration = input("Enter duration in minutes (default 1): ").strip() or "1"
            format_choice = input("Output format (console/jsonl, default console): ").strip() or "console"
